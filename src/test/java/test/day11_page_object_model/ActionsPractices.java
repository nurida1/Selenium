...
public class ActionsPractices {
    ...
    public void tc16_double_click_test() {
        ...
        // 2.Switch	to	iframe.
        //1-index, 2-id-name, 3-locate it as a webElement and pass it into
        ...
        // 4.Assert:	Text’s	“style”	attribute	value	conta
    ...
    @Test
    public void tc17_drag_and_drop_test() throws Exception {
        ...
        //1st solution:
        //actions.clickAndHold(smallCircle).moveToElement(bigCircle).release().perform();  release - let it go :D
        //changed to "Now drop..." requirement, just to test:
        ...
        //verify that it's changing to "Drop here"
    ...
    public void tc18_right_click_test () {
        ...
        // No	assertion	needed	for	this	pra
