...
public class NegativeLoginTests {
    ...
    public void negative_login_test() {
        ...
        passwordInput.sendKeys("klsdgjof");
    ...
    @Test
    public void neagaitve_login_test_with_page_object() {
        Driver.getDriver().get(ConfigurationReader.getProperty("vytrack_url"));
    ...
    public void tc31_wrong_username_test() {
        ...
        String username = "something"; //not correct
        String password =ConfigurationReader.getProperty("storemanager_password"); //correct password
