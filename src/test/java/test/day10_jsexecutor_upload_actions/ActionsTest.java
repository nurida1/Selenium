...
public class ActionsTest {
    ...
    public void tc15_hover_test() throws Exception{
        ...
        WebElement user1 = Driver.getDriver().findElement(By.xpath("//h5[.='name: user1']")); //locating user under pictures, not displayed, just locating
        ...
        actions.moveToElement(img1).perform(); // to hover over image and assert
